...
import {IListItem} from '../app/interfaces' // Använder interface i TYPESCRIPT för att kunna skicka in props

export const ListItem: React.FC<IListItem> = ({list, deleteList}) => { // Så här måste vi skriva för att ta emot props i TYPESCRIPT
    return (
