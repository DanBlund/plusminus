...
export const ProductRow: React.FC<IProductRow> = ({product, deleteProduct}) => { // Så här måste vi skriva för att ta emot props i TYPESCRIPT
    console.log(product.dateSold)
    return (
        <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
            ...
            <td className="px-3 py-1">
                <ButtonSmall text={"Sell"} func={deleteProduct} funcParameter={product.id}/>
            </td>
        </tr>
    )
}
